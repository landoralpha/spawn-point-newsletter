...
5. **Hundo CP** (L20 ONLY — Max Battle catches are always L20, no weather-boosted L25; see `spawn_point_copy_accuracy.md`)
...
2. L20 hundo + L25 hundo with weather flag for RAID / CD species; **L20 only** for Max Battle species (no L25 catch; see `spawn_point_copy_accuracy.md`)
3. Sprite per row
