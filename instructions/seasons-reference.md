...
**Choose Your Path Timed Research** is a new Timed Research format introduced in the Forever Forward season — Niantic describes it as "a new way to play during non-event weeks" ([pokemongo.com/news/choose-your-path-forever-forward-2026](https://pokemongo.com/news/choose-your-path-forever-forward-2026)). The **first run was the unbranded "Choose Your Path Timed Research" event on May 19–24, 2026** (3 bonuses, no theme). **Fossil Fun (June 17–21, 2026) is the SECOND run** and the first themed one — Niantic doubled the bonus options to 6 and tied encounters to Cranidos/Shieldon. Subsequent weeks recur on the schedule below. During each listed non-event week, Trainers select **one of three paths — Explore, Catch, or Battle** — at the start of the week. The selected path determines that week's Timed Research tasks and bonuses. Different Trainers may see different research opportunities depending on path choice — LeekDuck has reported a possible "pick a new path each day" A/B variant for some accounts starting with Fossil Fun.

**Drafting note:** the format has been live since May 19, 2026. Do NOT phrase any Choose Your Path event as "the first" or "the debut of this format." Fossil Fun can be called "the second run" or "the first themed run" — both are accurate. Use "this week's Choose Your Path" or "the next Choose Your Path" for later events.
