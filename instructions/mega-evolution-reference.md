...
- **CRITICAL — Mega Energy is per-species, NOT generic.** Beedrill Mega Energy can ONLY be spent on Mega Beedrill (Mega Evolution OR spend-to-level). There is no conversion path between species, no generic Mega Energy pool. Mega Energy is unlike Rare Candy in this respect — it does NOT redistribute. Never write newsletter copy implying species-A Mega Energy can level species-B; this has been a recurring drafting error.
- **Editorial implication for newsletter copy:** "Mega Level only progresses once per day" is no longer the full picture starting May 23. It's now "free progression is gated to once per day per Pokémon; trainers who've already invested in THAT species can spend its Mega Energy to push past that cap, with discount based on Mega Evolution count of THAT species."
